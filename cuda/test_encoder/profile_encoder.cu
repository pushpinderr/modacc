...
int main(int argc, char* argv[]) {
   ...
   if(print_info){
    ...
    printf("qkv_linear:%f\n", sw.GetTimeInSeconds());
    #if EVENT_PROFILE
    printf("launch_bias_add_transform_0213\n");
#endif
...
#if EVENT_PROFILE
    printf("attention_probability_dropout\n");
#endif  
    ...
    sw.restart();
#if EVENT_PROFILE
    printf("launch_transform4d_0213\n");
#endif 
...
#if EVENT_PROFILE
    printf("attention_output_dropout\n");
#endif 
